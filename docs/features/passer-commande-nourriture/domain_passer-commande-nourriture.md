...
**Contexte**
La couche domaine porte les règles métier de la feature « Passer une commande de nourriture ». Le domaine calcule le coût selon type alimentaire (snack/repas).

**Critères d'acceptation**
Feature: Passer une commande de nourriture - Domaine
...
Given une requête qui viole la règle règle de coût nourriture non respectée
When le cas d'usage domaine est exécuté
