...
**Contexte**
La couche domaine porte les règles métier de la feature « Annuler une commande ». Le domaine applique les règles d'annulation et de remboursement des jetons.

**Critères d'acceptation**
Feature: Annuler une commande - Domaine
...
Given une requête qui viole la règle commande déjà acquittée non annulable
When le cas d'usage domaine est exécuté
