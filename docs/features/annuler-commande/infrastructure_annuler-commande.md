...
**Contexte**
La couche infrastructure implémente les ports nécessaires à la feature « Annuler une commande ». L'infrastructure annule la commande et crédite les jetons dans la même transaction.

**Critères d'acceptation**
Feature: Annuler une commande - Infrastructure
...
Given une exécution où la règle commande déjà acquittée non annulable conduit à un échec
