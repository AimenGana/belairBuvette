# Transférer des jetons à un autre festivalier : Domaine

**Contexte**
La couche domaine porte les règles métier de la feature « Transférer des jetons à un autre festivalier ». Le domaine contrôle plafond de transfert, confirmation destinataire et non-négativité.

**Critères d'acceptation**
Feature: Transférer des jetons à un autre festivalier - Domaine
...
Given une requête qui viole la règle transfert dépassant 3 jetons par type
When le cas d'usage domaine est exécuté
