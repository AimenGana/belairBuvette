# Envoyer des notifications régulières d'hydratation : Domaine

**Contexte**
La couche domaine porte les règles métier de la feature « Envoyer des notifications régulières d'hydratation ». Le domaine définit cadence standard et cadence renforcée selon consommation alcoolisée.

**Critères d'acceptation**
Feature: Envoyer des notifications régulières d'hydratation - Domaine
...
Given une requête qui viole la règle envoi hors plage 11h00-19h00
When le cas d'usage domaine est exécuté
