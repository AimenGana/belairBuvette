# Consulter le solde restant de jetons : Domaine

**Contexte**
La couche domaine porte les règles métier de la feature « Consulter le solde restant de jetons ». La feature manipule deux types de jetons (boisson/nourriture) et le cycle journalier.

**Critères d'acceptation**
Feature: Consulter le solde restant de jetons - Domaine
...
Given une requête qui viole la règle solde négatif de jetons
When le cas d'usage domaine est exécuté
