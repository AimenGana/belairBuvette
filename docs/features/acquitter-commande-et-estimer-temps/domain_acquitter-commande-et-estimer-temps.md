# Acquitter une commande et estimer le temps de préparation : Domaine

**Contexte**
La couche domaine porte les règles métier de la feature « Acquitter une commande et estimer le temps de préparation ». Le domaine calcule l'ETA selon les règles de boissons/snacks/repas et mix.

**Critères d'acceptation**
Feature: Acquitter une commande et estimer le temps de préparation - Domaine
...
Given une requête qui viole la règle calcul ETA non conforme aux règles de types d'articles
When le cas d'usage domaine est exécuté
