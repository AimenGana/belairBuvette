...
description: This prompt is used to refactor Green-step code by moving production logic out of tests into proper production classes while preserving behavior in a TDD workflow for an AI agent
